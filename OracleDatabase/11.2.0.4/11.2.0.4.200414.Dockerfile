...
COPY  --chown=oracle:oinstall software/PSU_11.2.0.4.200414/*zip* "${SOFTWARE}/"
...
ENV   DB_PATCH_PKG="p30670774_112040_Linux-x86-64.zip" \
      DB_OJVM_PKG="p30805543_112040_Linux-x86-64.zip" \
