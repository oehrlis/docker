...
COPY  --chown=oracle:oinstall software/RU_19.10.0.0/*zip* "${SOFTWARE}/"
...
ENV   DB_PATCH_PKG="p32218454_190000_Linux-x86-64.zip" \
      DB_OJVM_PKG="p32067171_190000_Linux-x86-64.zip" \
      DB_OPATCH_PKG="p6880880_190000_Linux-x86-64.zip" \
      DB_JDKPATCH_PKG="p32162391_190000_Linux-x86-64.zip" \
