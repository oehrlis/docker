...
COPY  --chown=oracle:oinstall software/RU_19.11.0.0/*zip* "${SOFTWARE}/"
...
ENV   DB_PATCH_PKG="p32545013_190000_Linux-x86-64.zip" \
      DB_OJVM_PKG="p32399816_190000_Linux-x86-64.zip" \
      DB_OPATCH_PKG="p6880880_190000_Linux-x86-64.zip" \
      DB_JDKPATCH_PKG="p32490416_190000_Linux-x86-64.zip" \
