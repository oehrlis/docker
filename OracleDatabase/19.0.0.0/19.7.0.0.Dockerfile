...
COPY  --chown=oracle:oinstall software/RU_19.7.0.0/*zip* "${SOFTWARE}/"
...
ENV   DB_PATCH_PKG="p30869156_190000_Linux-x86-64.zip" \
      DB_OJVM_PKG="p30805684_190000_Linux-x86-64.zip" \
