...
COPY  --chown=oracle:oinstall software/RU_19.13.0.0/*zip* "${SOFTWARE}/"
...
ENV   DB_PATCH_PKG="p33192793_190000_Linux-x86-64.zip" \
      DB_OJVM_PKG="p33192694_190000_Linux-x86-64.zip" \
      DB_OPATCH_PKG="p6880880_190000_Linux-x86-64.zip" \
      DB_JDKPATCH_PKG="p33197296_190000_Linux-x86-64.zip" \
