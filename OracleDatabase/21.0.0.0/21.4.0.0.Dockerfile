...
COPY  --chown=oracle:oinstall software/RU_21.4.0.0/*zip* "${SOFTWARE}/"
...
ENV   DB_PATCH_PKG="p33239276_210000_Linux-x86-64.zip" \
      DB_OJVM_PKG="" \
      DB_OPATCH_PKG="p6880880_210000_Linux-x86-64.zip" \
      DB_JDKPATCH_PKG="p33197565_210000_Linux-x86-64.zip" \
      DB_PERLPATCH_PKG="" \
      DB_ONEOFF_PKGS=""
