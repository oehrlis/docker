...
COPY  --chown=oracle:oinstall software/PSU_12.1.0.2.210420/*zip* "${SOFTWARE}/"
...
ENV   DB_PATCH_PKG="p32518631_121020_Linux-x86-64.zip" \
      DB_OJVM_PKG="p32473164_121020_Linux-x86-64.zip" \
      DB_OPATCH_PKG="p6880880_121010_Linux-x86-64.zip" \
      DB_JDKPATCH_PKG="p32494568_121020_Linux-x86-64.zip" \
      DB_PERLPATCH_PKG="p31858428_121020_Linux-x86-64.zip" \
      DB_ONEOFF_PKGS=""
