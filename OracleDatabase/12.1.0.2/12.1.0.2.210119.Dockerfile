...
COPY  --chown=oracle:oinstall software/PSU_12.1.0.2.210119/*zip* "${SOFTWARE}/"
...
ENV   DB_PATCH_PKG="p31985579_121020_Linux-x86-64.zip" \
      DB_OJVM_PKG="p32119956_121020_Linux-x86-64.zip" \
      DB_OPATCH_PKG="p6880880_121010_Linux-x86-64.zip" \
      DB_JDKPATCH_PKG="p32162885_121020_Linux-x86-64.zip" \
