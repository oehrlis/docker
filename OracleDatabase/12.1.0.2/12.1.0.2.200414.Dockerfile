...
COPY  --chown=oracle:oinstall software/PSU_12.1.0.2.200414/*zip* "${SOFTWARE}/"
...
ENV   DB_PATCH_PKG="p30700212_121020_Linux-x86-64.zip" \
      DB_OJVM_PKG="p30805558_121020_Linux-x86-64.zip" \
