...
# Date.......: 2019.10.17
# Purpose....: Dockerfile to build Oracle Database image 18.7.0.0
# Notes......: --
# Reference..: --
...
ENV   SETUP_DB="10_setup_db.sh" \
      DB_BASE_PKG="LINUX.X64_180000_db_home.zip" \
      DB_EXAMPLE_PKG="" \
      DB_PATCH_PKG="p29757256_180000_Linux-x86-64.zip" \
      DB_OJVM_PKG="p29249584_180000_Linux-x86-64.zip" \
      DB_OPATCH_PKG="p6880880_180000_Linux-x86-64.zip"

# stuff to run a DB instance
ENV   ORACLE_SID=${ORACLE_SID:-"TDB180S"} \
      ORACLE_HOME_NAME="18.0.0.0" \
      ORACLE_MAJOR_RELEASE="180" \
...
ENV   PATH=${PATH}:"${ORACLE_BASE}/product/${ORACLE_HOME_NAME}/bin:${ORADBA_INIT}:${ORACLE_BASE}/product/${ORACLE_HOME_NAME}/OPatch/:/usr/sbin:$PATH" \
      ...
      RESPONSFILE_VERSION="oracle.install.responseFileVersion=/oracle/install/rspfmt_dbinstall_response_schema_v18.0.0"
