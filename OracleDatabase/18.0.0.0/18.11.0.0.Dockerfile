...
COPY  --chown=oracle:oinstall software/RU_18.11.0.0/*zip* "${SOFTWARE}/"
...
ENV   DB_PATCH_PKG="p31308624_180000_Linux-x86-64.zip" \
      DB_OJVM_PKG="p31219909_180000_Linux-x86-64.zip" \
