...
COPY  --chown=oracle:oinstall software/RU_18.12.0.0/*zip* "${SOFTWARE}/"
...
ENV   DB_PATCH_PKG="p31730250_180000_Linux-x86-64.zip" \
      DB_OJVM_PKG="p31668892_180000_Linux-x86-64.zip" \
      DB_OPATCH_PKG="p6880880_180000_Linux-x86-64.zip" \
      DB_JDKPATCH_PKG="p31749759_180000_Linux-x86-64.zip" \
