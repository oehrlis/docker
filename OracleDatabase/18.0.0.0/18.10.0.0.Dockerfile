...
COPY  --chown=oracle:oinstall software/RU_18.10.0.0/*zip* "${SOFTWARE}/"
...
ENV   DB_PATCH_PKG="p30872794_180000_Linux-x86-64.zip" \
      DB_OJVM_PKG="p30805598_180000_Linux-x86-64.zip" \
