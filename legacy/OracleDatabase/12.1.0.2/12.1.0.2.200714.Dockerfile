...
ENV   DB_BASE_PKG="linuxamd64_12102_database_1of2.zip" \
      DB_BASE2_PKG="linuxamd64_12102_database_2of2.zip" 

# stuff to run a DB instance
ENV   ORACLE_SID=${ORACLE_SID:-"TDB120S"} \
      ORACLE_HOME_NAME="12.1.0.2" \
...
COPY  --chown=oracle:oinstall software/PSU_12.1.0.2.200714/*zip* "${SOFTWARE}/"
...
ENV   DB_PATCH_PKG="p31113348_121020_Linux-x86-64.zip" \
      DB_OJVM_PKG="p31219939_121020_Linux-x86-64.zip" \
      DB_OPATCH_PKG="p6880880_121010_Linux-x86-64.zip" \
      DB_JDKPATCH_PKG="p31302525_121020_Linux-x86-64.zip" \
      DB_PERLPATCH_PKG="p30508171_121020_Linux-x86-64.zip" \
      DB_ONEOFF_PKGS="p30193165_12102200714_Linux-x86-64.zip;p27667128_12102200714_Generic.zip"
