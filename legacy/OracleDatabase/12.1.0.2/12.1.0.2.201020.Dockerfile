...
COPY  --chown=oracle:oinstall software/PSU_12.1.0.2.201020/*zip* "${SOFTWARE}/"
...
ENV   DB_PATCH_PKG="p31550110_121020_Linux-x86-64.zip" \
      DB_OJVM_PKG="p31668915_121020_Linux-x86-64.zip" \
      DB_OPATCH_PKG="p6880880_121010_Linux-x86-64.zip" \
      DB_JDKPATCH_PKG="p31749725_121020_Linux-x86-64.zip" \
