...
COPY  --chown=oracle:oinstall software/RU_19.8.0.0/*zip* "${SOFTWARE}/"
...
ENV   DB_PATCH_PKG="p31281355_190000_Linux-x86-64.zip" \
      DB_OJVM_PKG="p31219897_190000_Linux-x86-64.zip" \
