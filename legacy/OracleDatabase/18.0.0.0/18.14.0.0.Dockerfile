...
ENV   DB_BASE_PKG="LINUX.X64_180000_db_home.zip"
...
COPY  --chown=oracle:oinstall software/RU_18.14.0.0/*zip* "${SOFTWARE}/"
...
ENV   DB_PATCH_PKG="p32524155_180000_Linux-x86-64.zip" \
      DB_OJVM_PKG="p32552752_180000_Linux-x86-64.zip" \
      DB_OPATCH_PKG="p6880880_180000_Linux-x86-64.zip" \
      DB_JDKPATCH_PKG="p32494267_180000_Linux-x86-64.zip" \
      DB_PERLPATCH_PKG="p31858032_180000_Linux-x86-64.zip" \
      DB_ONEOFF_PKGS=""
