...
COPY  --chown=oracle:oinstall software/RU_18.13.0.0/*zip* "${SOFTWARE}/"
...
ENV   DB_PATCH_PKG="p32204699_180000_Linux-x86-64.zip" \
      DB_OJVM_PKG="p32119939_180000_Linux-x86-64.zip" \
      DB_OPATCH_PKG="p6880880_180000_Linux-x86-64.zip" \
      DB_JDKPATCH_PKG="p32162724_180000_Linux-x86-64.zip" \
