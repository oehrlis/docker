...
COPY  --chown=oracle:oinstall software/RU_12.2.0.1.200414/*zip* "${SOFTWARE}/"
...
ENV   DB_PATCH_PKG="p30886680_122010_Linux-x86-64.zip" \
      DB_OJVM_PKG="p30805580_122010_Linux-x86-64.zip" \
      DB_OPATCH_PKG="p6880880_122010_Linux-x86-64.zip" \
      DB_JDKPATCH_PKG="p31302499_122010_Linux-x86-64.zip" \
      DB_PERLPATCH_PKG="p30508161_122010_Linux-x86-64.zip" \
      DB_ONEOFF_PKGS=""
