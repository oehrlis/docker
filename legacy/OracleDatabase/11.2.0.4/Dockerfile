...
ENV   DB_BASE_PKG="p13390677_112040_Linux-x86-64_1of7.zip" \
...
COPY  --chown=oracle:oinstall software/PSU_11.2.0.4.201020/*zip* "${SOFTWARE}/"
...
ENV   DB_PATCH_PKG="p31537677_112040_Linux-x86-64.zip" \
      DB_OJVM_PKG="p31668908_112040_Linux-x86-64.zip" \
      DB_OPATCH_PKG="p6880880_112000_Linux-x86-64.zip" \
      DB_JDKPATCH_PKG="p31749197_112040_Linux-x86-64.zip" \
